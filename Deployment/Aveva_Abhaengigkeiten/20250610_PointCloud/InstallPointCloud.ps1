...
$depPath = join-path $deployment '\Aveva_Abhaengigkeiten\20250610_PointCloud'
...
#"\\eundc\eundcdata\Install\02_Deployment> .\Aveva_Abhaengigkeiten\20250610_PointCloud\dotnet-runtime-5.0.17-win-x86.exe /install /quiet /log C:\temp\DOTNET.log"

"#Installiere Point Cloud Manager"
start-process ( join-path $depPath 'AVEVA Point Cloud ManagerSetup.24.3.0.0.exe' ) -argumentlist "/VERYSILENT /NORESTART /NOCLOSEAPPLICATIONS /NOICONS /log=C:\temp\PCM.log" -wait
